...
public class LivroRepositoryJdbc implements ILivroRepository{
    ...
    private void inserirLivro(Connection conexao, Livro lviro) {

        String sql = "INSERT INTO livro(isbn, titulo, ano_publlicacao) VALUES (?, ?, ?)";

    }

    private void atualizarLivro(Connection conexao, Livro lviro) {
